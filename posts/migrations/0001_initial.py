    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shared_song', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='shared_in_posts', to='music.song', verbose_name='Bài hát chia sẻ')),
            ],
            options={
                'db_table': 'posts_post',
                'ordering': ['-created_at'],
