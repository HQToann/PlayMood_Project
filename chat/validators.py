...
def validate_message_content(content: str, image_url: str, shared_song_id: str = None, shared_album_id: str = None, shared_playlist_id: str = None):
    """
    Kiểm tra tính hợp lệ của tin nhắn:
    Phải có ít nhất 1 trong 4 thứ: text, hình ảnh, bài hát, album, playlist.
    """
